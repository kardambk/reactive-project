...
public interface ResourceApi {
    ...
    default Mono<ResponseEntity<Resource>> createResource(
        @Parameter(name = "Resource", description = "", schema = @Schema(description = "")) @Valid @RequestBody(required = false) Mono<Resource> resource,
        @Parameter(hidden = true) final ServerWebExchange exchange
    ) {
        return getDelegate().createResource(resource, exchange);
    }
    ...
    default Mono<ResponseEntity<Resource>> getResourceById(
        @Parameter(name = "id", description = "Unique Id of a Resource", required = true, schema = @Schema(description = "")) @PathVariable("id") Integer id,
        @Parameter(hidden = true) final ServerWebExchange exchange
    ) {
        return getDelegate().getResourceById(id, exchange);
    }
    ...
    default Mono<ResponseEntity<Resource>> updateResource(
        @Parameter(name = "Resource", description = "", schema = @Schema(description = "")) @Valid @RequestBody(required = false) Mono<Resource> resource,
        @Parameter(hidden = true) final ServerWebExchange exchange
    ) {
        return getDelegate().updateResource(resource, exchange);
    }
